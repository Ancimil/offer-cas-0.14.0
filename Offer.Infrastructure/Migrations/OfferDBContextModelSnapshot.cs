...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Offer.Domain.AggregatesModel.ApplicationAggregate.Application", b =>
                {
                    ...
                    b.Property<bool?>("CustomerApplied");
                    ...
                    b.Property<string>("_AvailableProducts")
            ...
            modelBuilder.Entity("Offer.Domain.AggregatesModel.ApplicationAggregate.ArrangementRequest", b =>
                {
                    ...
                    b.Property<int>("InstallmentScheduleDayOfMonth");
                    ...
                    b.Property<string>("_ProductSnapshotHash")
                        .HasColumnName("ProductSnapshotHash");

                    b.Property<string>("_RequestedValues");

                    b.HasKey("ApplicationId", "ArrangementRequestId");

                    b.HasIndex("_ProductSnapshotHash");
            ...
            modelBuilder.Entity("Offer.Domain.AggregatesModel.ApplicationAggregate.Party", b =>
                {
                    ...
                    b.Property<string>("ConsentsGiven");
                    ...
                    b.Property<bool?>("EmploymentDataVerified");

                    b.Property<bool?>("HasRepresentative");

                    b.Property<bool?>("HouseholdInformationVerified");

                    b.Property<bool?>("IdDataVerified");
                    ...
                    b.Property<bool?>("IsRegisteredAsCustomer");

                    b.Property<bool?>("IsRegisteredAsProspect");

                    b.Property<bool?>("KycQuestionnaireFilled");

                    b.Property<bool?>("PartyDataLoaded");
                    ...
                    b.Property<bool?>("ProfileDataLoaded");

                    b.Property<string>("ProfileImageUrl");

                    b.Property<string>("ProspectNumber");
            ...
            modelBuilder.Entity("Offer.Domain.AggregatesModel.ApplicationAggregate.ProductSnapshotDb", b =>
                {
                    b.Property<string>("Hash")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("_ProductSnapshot")
                        .HasColumnName("ProdctSnapshot");

                    b.HasKey("Hash");

                    b.ToTable("product_snapshots");
                });
            ...
            modelBuilder.Entity("Offer.Domain.AggregatesModel.ApplicationAggregate.ArrangementRequest", b =>
                {
                    ...
                    b.HasOne("Offer.Domain.AggregatesModel.ApplicationAggregate.ProductSnapshotDb", "ProductSnapshotDb")
                        .WithMany("ArrangementRequests")
                        .HasForeignKey("_ProductSnapshotHash");
                });
                    ...
                    b.OwnsOne("Offer.Domain.AggregatesModel.ApplicationAggregate.SavingsPlan", "SavingsPlan", b1 =>
                        {
                            ...
                            b1.ToTable("arrangement_requests","offer");
