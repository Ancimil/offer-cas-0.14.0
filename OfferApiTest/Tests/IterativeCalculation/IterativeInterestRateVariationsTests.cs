...
{
    public class IterativeInterestRateVariationsTests
    {
        ...
        public void IterativeVariationOnRateWithinLimitsLower()
        {
            ...
            {
                VariationsDefinitionDMN = "product/price-variations/iterative-int-rate-remove.dmn",
            ...
            //Asserting variation
            Assert.Equal((decimal)-0.99, variation.Percentage);
            ...
            Assert.Equal((decimal)10.11, ((TermLoanRequest)result.Result).Napr);
            Assert.Equal((decimal)10.11, resultInterest.CalculatedRate);
        ...
        //No variations, calc rates should be as they are set in the request
        //Rate is within limits
        public void IterativeVariationOnRateWithinLimitsUpper()
        {
            ConfigurationServiceMock configurationService = new ConfigurationServiceMock();
            PriceCalculationDMNServiceMock priceCalCService = new PriceCalculationDMNServiceMock(configurationService);
            MarketRatesServiceMock marketRatesService = new MarketRatesServiceMock();
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                VariationsDefinitionDMN = "product/price-variations/iterative-int-rate-add.dmn",
                Kind = InterestRateKinds.RegularInterest,
                Rate = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
            ...
            //Asserting Napr and calculation results
            Assert.Equal((decimal)17.89, ((TermLoanRequest)result.Result).Napr);
            Assert.Equal((decimal)17.89, resultInterest.CalculatedRate);
            Assert.Equal((decimal)10.0, resultInterest.CalculatedLowerLimit);
            Assert.Equal((decimal)18.0, resultInterest.CalculatedUpperLimit);
        }
        ...
        //No variations, calc rates should be as they are set in the request
        //Rate is within limits
        public void IterativeVariationOnRateUnderLowerLimit()
        {
            ConfigurationServiceMock configurationService = new ConfigurationServiceMock();
            PriceCalculationDMNServiceMock priceCalCService = new PriceCalculationDMNServiceMock(configurationService);
            MarketRatesServiceMock marketRatesService = new MarketRatesServiceMock();
        ...
        [Fact]
        public void IterativeVariationOnRateOverUpperLimit()
        {
            ConfigurationServiceMock configurationService = new ConfigurationServiceMock();
            PriceCalculationDMNServiceMock priceCalCService = new PriceCalculationDMNServiceMock(configurationService);
            MarketRatesServiceMock marketRatesService = new MarketRatesServiceMock();
        ...
        public void VariationOnUpperLimitRateInRange()
        {
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                ...
                UpperLimitVariationsDefinitionDMN = "product/price-variations/iterativeint-rate-remove.dmn",
                UpperLimit = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                    SpreadRateValue = 18
        ...
        public void VariationsOnRateAndUpperLimitRateInLimit()
        {
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                VariationsDefinitionDMN = "product/price-variations/iterativeint-rate-add.dmn",
                Kind = InterestRateKinds.RegularInterest,
                Rate = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                ...
                UpperLimitVariationsDefinitionDMN = "product/price-variations/iterativeint-rate-add.dmn",
                UpperLimit = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                    SpreadRateValue = 18
        ...
        public void VariationsOnRateAndUpperLimitRateOverUpperLimit()
        {
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                VariationsDefinitionDMN = "product/price-variations/iterativeint-rate-add2.dmn",
                Kind = InterestRateKinds.RegularInterest,
                Rate = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
        ...
        public void MultipleVariationsOnRateAndUpperLimitRateInRange()
        {
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                VariationsDefinitionDMN = "product/price-variations/iterativeint-rate-add-two-variations.dmn",
                Kind = InterestRateKinds.RegularInterest,
                Rate = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                ...
                UpperLimitVariationsDefinitionDMN = "product/price-variations/iterativeint-rate-add-two-variations.dmn",
                UpperLimit = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                    SpreadRateValue = 18
        ...
        public void VariationOnLowerLimitRateInRange()
        {
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                ...
                LowerLimitVariationsDefinitionDMN = "product/price-variations/iterativeint-rate-add.dmn",
                LowerLimit = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                    SpreadRateValue = 10
        ...
        public void VariationOnLowerLimitRateUnderLimit()
        {
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                ...
                LowerLimitVariationsDefinitionDMN = "product/price-variations/iterativeint-rate-remove.dmn",
                LowerLimit = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                    SpreadRateValue = 12
        ...
        public void VariationsOnRateAndLowerLimitRateUnderLowerLimit()
        {
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                ...
                LowerLimitVariationsDefinitionDMN = "product/price-variations/iterativeint-rate-add2.dmn",
                LowerLimit = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                    SpreadRateValue = 10
        ...
        public void MultipleVariationsOnRateAndLowerLimitRateInRange()
        {
            ...
            InterestRateCondition regularInterestEuribor = new InterestRateCondition
            {
                ...
                LowerLimitVariationsDefinitionDMN = "product/price-variations/iterativeint-rate-add-two-variations.dmn",
                LowerLimit = new InterestRate
                {
                    BaseRateId = "EURIBOR-6M",
                    SpreadRateValue = 10
